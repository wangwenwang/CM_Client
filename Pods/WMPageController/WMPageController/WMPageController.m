...
- (void)rightItemOnclick {
    ...
    UIColor *titleColor = [UIColor colorWithRed:55 / 255.0 green:55 / 255.0 blue:55 / 255.0 alpha:1];
    
    YCXMenuItem *menu1 = [YCXMenuItem menuItem:@"全部车队" image:nil tag:10086 userInfo:nil];
    menu1.foreColor = titleColor;
    
    YCXMenuItem *menu2 = [YCXMenuItem menuItem:@"我的车队" image:nil tag:10087 userInfo:nil];
    menu2.foreColor = titleColor;
    
    YCXMenuItem *menu3 = [YCXMenuItem menuItem:@"合约车队" image:nil tag:10088 userInfo:nil];
    menu3.foreColor = titleColor;
    
    [YCXMenu setTintColor:[UIColor colorWithRed:213 / 255.0 green:213 / 255.0 blue:213 / 255.0 alpha:1]];
    
    [YCXMenu setSelectedColor:[UIColor colorWithRed:200 / 255.0 green:200 / 255.0 blue:200 / 255.0 alpha:1]];
    
    NSArray *items = @[menu1, menu2, menu3];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    UIBarButtonItem *rightItem = [[UIBarButtonItem alloc]initWithTitle:_rightItemTitle style:UIBarButtonItemStyleDone target:self action:@selector(rightItemOnclick)];
