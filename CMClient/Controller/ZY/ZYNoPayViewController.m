...
@interface ZYNoPayViewController ()<UITableViewDelegate, UITableViewDataSource, ZYListServiceDelegate> {
...
//请求状态
#define REQUSTSTATUS @"UNFINISH"
#define kPageCount 20
#define kCellHeight 103

@implementation ZYNoPayViewController
