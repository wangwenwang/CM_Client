...
@interface ZYPayedViewController ()<UITableViewDelegate, UITableViewDataSource, ZYListServiceDelegate> {
...
//请求状态
#define REQUSTSTATUS @"FINISH"
#define kPageCount 20
#define kCellHeight 103

@implementation ZYPayedViewController
